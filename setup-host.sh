...
echo ""
echo "Now run the Guest Script"
echo "sudo apt install git & git clone https://github.com/just-stuff-tm/pixel-debian-cellular.git & cd pixel-debian-cellular & chmod +x setup-guest.sh & sudo ./setup-guest.sh) inside your Pixel Linux Terminal."
